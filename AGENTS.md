...
# AGENTS.md — Governed Swarm Assignment: coves7.com
...
repo: coves7.com
type: static-site
canonical_purpose: Static HTML affiliate/content site â€” AI tools, prompts, resources
authority_ceiling: 1
```
...
iteration:
  ...
  branch_pattern: "agency/coves7.com/{gap_id}"
  pr_title_pattern: "swarm(coves7.com): {gap_id} — {description}"
